...
%Animals: NVI20, NVI21
animal = 'NVI21'; day = 'D1';
% folder = 'E:\holobmi_E\200315_E' %'E:\holobmi_E\200305';
folder = 'H:\holobmi_H\200315_H' %'E:\holobmi_E\200305';
...
%-change tif directory to im
%-change filename to redgreen
%-decrement file number to 0
%set #Repst to 4000
%collect video
%--------------------------------------------------------------------------
%DO:
...
num_reps = 1; %how many times should we stim each grid point
...
save(fullfile(savePath, 'fine_grid.mat')); 
...
save(fullfile(savePath, 'coarse_grid.mat')); 
% if position of stim cells looks different, "smaller/bigger" check the
% pixel size
%--------------------------------------------------------------------------
%DO: 
...
idx = 0;
idx = idx + 1; 
analysis_paths{idx} = fullfile('E:\holobmi_E\200310\NVI20\D0\im', 'redgreen-000'); 
idx = idx + 1;
analysis_paths{idx} = fullfile('E:\holobmi_E\200310\NVI20\D0\im', 'roi_stim-000'); 
idx = idx + 1;
analysis_paths{idx} = fullfile('E:\holobmi_E\200310\NVI20\D0\im', 'coarse_gridstim-000'); 
idx = idx + 1;
analysis_paths{idx} = fullfile('E:\holobmi_E\200310\NVI20\D0\im', 'coarse_gridstim-001'); 
idx = idx + 1;
analysis_paths{idx} = fullfile('E:\holobmi_E\200310\NVI20\D0\im', 'coarse_gridstim-002'); 
idx = idx + 1;
analysis_paths{idx} = fullfile('H:\holobmi_H\200310\NVI20\D0\im', 'fine_gridstim-000'); 
idx = idx + 1;
analysis_paths{idx} = fullfile('H:\holobmi_H\200310\NVI20\D0\im', 'fine_gridstim-001'); 
idx = idx + 1;
analysis_paths{idx} = fullfile('H:\holobmi_H\200310\NVI20\D0\im', 'fine_gridstim-002'); 
