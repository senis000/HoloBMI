...
idx = idx+1; 
file_cell{idx} = 'D:\Dropbox\Data\grid_stim\200311\coarse_gridstim-000\psth_data.mat';
idx = idx+1; 
file_cell{idx} = 'D:\Dropbox\Data\grid_stim\200311\coarse_gridstim-001\psth_data.mat';
idx = idx+1; 
file_cell{idx} = 'D:\Dropbox\Data\grid_stim\200311\coarse_gridstim-002\psth_data.mat';
idx = idx+1; 
file_cell{idx} = 'D:\Dropbox\Data\grid_stim\200311\coarse_gridstim-003\psth_data.mat';
idx = idx+1; 
file_cell{idx} = 'D:\Dropbox\Data\grid_stim\200311\coarse_gridstim-004\psth_data.mat';
num_files = length(file_cell)
for i = 1:num_files
    exist(file_cell{i})
end
save_dir = 'D:\Dropbox\Data\grid_stim\200311_coarsegrid';
mkdir(save_dir); 
%%
