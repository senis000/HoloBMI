...
clear all
date_str    = '200214'
file_analyze = 'stim-005'

tif_dir     = fullfile('D:\DATA\grid_stim\200214\NVI20\D0\redgreen', file_analyze); 
data_dir    = ['D:\DATA\grid_stim\200214\NVI20\D0\data_' file_analyze];
...
im_bg_path = fullfile(['D:\DATA\grid_stim\200214\NVI20\D0\data_' file_analyze], ['AVG_' file_analyze '.tif']); 
exist(im_bg_path)
...
%%
%Load the voltageRec file: 
voltageRec_path = fullfile(tif_dir, [file_analyze '_Cycle00001_VoltageRecording_001.csv']); 
