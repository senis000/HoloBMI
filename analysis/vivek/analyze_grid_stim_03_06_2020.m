...
clear all
date_str    = '200306'
file_analyze = 'coarse_grid-001' %'stim-005'

tif_dir     = ['D:\DATA\grid_stim\200306\NVI20\D0\im\' file_analyze] %coarse_grid-000'
data_dir    = 'D:\DATA\grid_stim\200306\NVI20\D0\coarse_grid_data' %['D:\DATA\grid_stim\200214\NVI20\D0\data_' file_analyze];
load_path   = fullfile(data_dir, 'matlab.mat')
save_dir    = fullfile('D:\Dropbox\Data\grid_stim', date_str, file_analyze); 
mkdir(save_dir); 

im_bg_path = fullfile('D:\DATA\grid_stim\200306\NVI20\D0\redgreen', 'green.tif'); 
