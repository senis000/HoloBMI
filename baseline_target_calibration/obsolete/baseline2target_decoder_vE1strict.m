function baseline2target_decoder_vE1strict(in)
%Updated 7.2.19
%4.18.19
%inputs:
...
%%
%Define cursor2freq mapping:
%is target low or high feedback
%should feedback be delivered

cursor2freq.cursor_max = T; %this cursor val is mapped to one extreme feedback
cursor2freq.cursor_max = 
...
save(save_path, ...
    'AComp_BMI', 'n_mean', 'n_std', 'decoder', 'E_id', 'E1_sel_idxs', 'E2_sel_idxs', 'E1_base', 'E2_base', 'T1', 'E1_thresh', 'E1_coeff', 'E1_std', 'E2_subord_thresh', 'E2_coeff', 'E2_subord_mean', 'E2_subord_std'); 
