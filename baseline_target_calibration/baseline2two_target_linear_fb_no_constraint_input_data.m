function [cal, BMI_roi_path] = baseline2two_target_linear_fb_no_constraint_input_data(baseActivity, roi_data_file, task_settings, ...
    E1_base, E2_base, save_dir)
%baseActivity: num_neurons x num_samples, can include NaN
