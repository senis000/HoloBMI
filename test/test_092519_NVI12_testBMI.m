...
base_file       = fullfile(data_dir, 'BaselineOnline190926T140545.mat'); 
bmi_file        = fullfile(data_dir, 'BMI_online190926T160533.mat'); 
cal_file        = fullfile(data_dir, 'BMI_target_info_20190926T143224.mat');
cal_ALL_file    = fullfile(data_dir, 'target_calibration_ALL_20190926T143224.mat'); 
...
%%
if single_bool    
    bmi_dir = '/Users/vivekathalye/Dropbox/Data/holo_sep2019/NVI12/bmi_sim_single/NVI12/D0'
    bmi_path = fullfile(bmi_dir, 'BMI_online190927T233717.mat'); 
    exist(bmi_path)
...
%     bmi_path = fullfile(bmi_dir, 'BMI_online190927T233717.mat'); 
%
%Saved Data said 1017 selfTargetCounter
%Re-simulated found 32 hits
